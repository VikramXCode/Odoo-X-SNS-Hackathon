...
export default defineConfig({
  head: [
    ["link", { rel: "icon", href: "/globalrouter.png" }],
  ...
  sitemap: {
    hostname: "https://globalrouter.app",
  },
  ...
  transformPageData(pageData) {
    if (pageData.relativePath === "index.md") {
      const jsonLd = {
        ...
        name: "Global Router",
        url: "https://globalrouter.app",
        applicationCategory: "TravelApplication",
        operatingSystem: "Web, Docker, Linux",
        description:
          "Global Router is a self-hosted platform for tracking and planning travel experiences. Built for modern explorers, it offers trip planning, journaling, tracking and location mapping in one privacy-respecting package.",
        creator: {
          "@type": "Person",
          name: "Global Router Team",
          url: "https://globalrouter.app",
        },
        offers: {
          "@type": "Offer",
        ...
        screenshot:
          "https://raw.githubusercontent.com/seanmorley15/Global Router/refs/heads/main/brand/screenshots/adventures.png",
  ...
  themeConfig: {
    ...
    nav: [
      { text: "Home", link: "/" },
      { text: "Docs", link: "/docs/intro/globalrouter_overview" },
    ],
    search: {
      provider: "local",
    },
    editLink: {
      pattern:
        "https://github.com/seanmorley15/Global Router/edit/main/documentation/:path",
    },

    footer: {
      message: "Global Router",
      copyright: "Copyright © 2026 Global Router Team",
    },

    logo: "/globalrouter.png",

    sidebar: [
      {
        text: "About Global Router",
        items: [
          {
            text: "Global Router Overview",

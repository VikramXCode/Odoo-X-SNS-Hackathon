...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: About
      link: /docs/intro/globalrouter_overview
    - theme: alt
      text: Demo
      link: https://demo.globalrouter.app
  image:
    src: ./globalrouter.svg
    alt: Global Router Map Logo
...
Get Global Router running in under 60 seconds:
...
> “I stumbled upon Global Router. It's an open-source, self-hosted travel planner that's completely free to use and has a bunch of cool features that make it a treat to plan, organize, and log your journey across the world. Safe to say, it's become a mainstay in Docker for me.”
>
...
> “The most important part of travelling in this socially connected world is to log everything and showcase all of your adventures. Global Router is aptly named, as it allows you to do just that. It just so happens to be one of the best apps for the job and can be fully self-hosted at home.”
>
...
> “Your travel memories are your personal treasures—don’t let them be held hostage by closed platforms, hidden fees, or privacy risks. Global Router represents a new era of travel tracking: open, private, comprehensive, and truly yours. Whether you’re a casual traveler, digital nomad, family vacation planner, or anyone who values their adventures, Global Router offers a compelling alternative that puts you back in control.”
>
> — _Open Source Daily_

[Article Link](https://opensourcedaily.blog/globalrouter-private-open-source-travel-tracking-trip-planning/)

:::

::: details 📱 **Android Authority**

> "Global Router behaves more like a super-charged travel journal than yet another travel app.”
>
...
Regular updates, new features, and community-driven improvements keep Global Router at the forefront of travel technology.
...
Global Router is lovingly maintained by passionate developers and supported by amazing users like you:

- ⭐ [Star us on GitHub](https://github.com/seanmorley15/Global Router)
- 💬 [Join our Discord community](https://discord.gg/wRbQ9Egr8C)
- 💖 [Sponsor The Project](https://seanmorley.com/sponsor) to help us keep improving Global Router
- 🐛 [Report bugs & request features](https://github.com/seanmorley15/Global Router/issues)
...
[**🚀 Get Started Now**](/docs/install/getting_started) • [**📱 Try the Demo**](https://demo.globalrouter.app) • [**📚 Read the Docs**](/docs/intro/globalrouter_overview)

# How to use Global Router

Welcome to Global Router! This guide will help you get started with Global Router and provide you with an overview of the features available to you.
...
- **Location**: think of a location as a point on a map, a place you want to visit, have visited, or a place you want to explore. A location can be anything you want it to be, from a local park to a famous landmark. These are the building blocks of Global Router and are the fundamental unit of information in the app.

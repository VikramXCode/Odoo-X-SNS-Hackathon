# Global Router Admin Panel

The Global Router Admin Panel, powered by Django, is a web-based interface that allows administrators to manage objects in the Global Router database. The Admin Panel is accessible at the `/admin` endpoint of the Global Router server. Example: `https://al-server.yourdomain.com/admin`.

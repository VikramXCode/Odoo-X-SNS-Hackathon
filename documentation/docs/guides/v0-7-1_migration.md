# Global Router v0.7.1 Migration

In order to make installation easier, the Global Router v0.7.1 release has **removed the need for a separate nginx container** and config to serve the media files. Instead, the media files are now served by an instance of nginx running in the same container as the Django application.
...
Enjoy the new version of Global Router! 🎉

View the full changelog [here](https://github.com/seanmorley15/Global Router/releases/tag/v0.7.1)

Report any bugs [GitHub repository](https://github.com/seanmorley15/globalrouter) or ask for help in the [Discord server](https://discord.gg/wRbQ9Egr8C).

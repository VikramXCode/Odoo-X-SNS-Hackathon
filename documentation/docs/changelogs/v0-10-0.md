...
- Choose whether to copy Immich images into Global Router storage or reference them via URL to avoid duplicating files.
...
- Follow our Mastodon profile at [@globalrouter@mastodon.social](https://mastodon.social/@globalrouter) for updates and discussion.
...
- **Timezone Migrations**
  If you have older trips without explicit timezones, simply view a trip’s detail page and Global Router will auto-convert the dates.
...
Every contribution helps make Global Router more reliable and user-friendly.

## 💖 Support the Project

If you find Global Router helpful, consider sponsoring me! Your support keeps this project going:

[https://seanmorley.com/sponsor](https://seanmorley.com/sponsor)

📖 [View the Full Changelog on GitHub](https://github.com/seanmorley15/Global Router/compare/v0.9.0...v0.10.0)

Thanks for being part of the Global Router community. I appreciate your feedback and look forward to seeing where your next journey takes you!

Happy travels,
**Sean Morley** (@seanmorley15)
Project Lead, Global Router

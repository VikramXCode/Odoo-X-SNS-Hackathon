# Global Router v0.11.0 - Strava + Wanderer Integration, New UI, and More

Released 09-02-2025

Hi everyone,

I’m thrilled to announce **Global Router v0.11.0** - a huge update that **completely reimagines how you track and plan your adventures**. Adventures are now officially called **Locations**, and you can enrich them with **Activities** and **Trails**, whether added manually or imported via Strava and Wanderer.
...
Every contribution makes Global Router more user-friendly and reliable.

---

## 💖 Support the Project

If you enjoy Global Router, consider sponsoring the project:

[https://seanmorley.com/sponsor](https://seanmorley.com/sponsor)

---

📖 [Full Changelog on GitHub](https://github.com/seanmorley15/Global Router/compare/v0.10.0...v0.11.0)

Thanks for being part of the Global Router community!

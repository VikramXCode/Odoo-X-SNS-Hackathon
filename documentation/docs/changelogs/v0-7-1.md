# Global Router v0.7.1

Released 11-13-2024

Hi everyone! I am super excited to announce the release of Global Router v0.7.1. This update includes a lot of improvements that make using Global Router more enjoyable and accessible. This update is largely community driven as it addresses more than 10 enhancement requests (thanks everyone!).
...
> The **migration guide** can be found here: https://docs.globalrouter.app/docs/Guides/nginx_migration

...
# GLOBALROUTER_CDN_URL = getenv('GLOBALROUTER_CDN_URL', 'https://cdn.globalrouter.app')

# Major release version of Global Router, not including the patch version date.
GLOBAL_ROUTER_RELEASE_VERSION = 'v0.11.0'
